                ...
                JUnit.TestSuites.Element.new().set(suites: [
                    JUnit.TestSuite.Element.new().set(testCases: [
                        JUnit.TestCase.Element.new().set(attributes: [
                            ...
                            JUnit.TestCase.Attribute.time(formattedValue: "1.1")
                            ]),
                        JUnit.TestCase.Element.new().set(attributes: [
                            ...
                            JUnit.TestCase.Attribute.time(formattedValue: "1.2")
                            ]).set(failures: [
                            ...
                            JUnit.TestSuite.Attribute.time(formattedValue: "10.78")
                            ]),
                    JUnit.TestSuite.Element.new().set(testCases: [
                        JUnit.TestCase.Element.new().set(attributes: [
                            JUnit.TestCase.Attribute.id(value: UUID.init(uuidString: "D60AD064-2BA3-461C-A278-A8A570865281")!),
                            JUnit.TestCase.Attribute.name(text: "2-1"),
                            JUnit.TestCase.Attribute.time(formattedValue: "2.1")
                            ]),
                        JUnit.TestCase.Element.new().set(attributes: [
                            ...
                            JUnit.TestSuite.Attribute.time(formattedValue: "113")
                            ]),
                    ]).set(attributes: [
